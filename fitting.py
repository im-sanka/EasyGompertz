...
st.info("In this platform, you can either add your data manually or upload a .csv/ .xlsx data that has two columns only - the first column is representing X axis and the second column will be added as Y axis.")
datasets = []
fit_names = []
